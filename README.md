...
```python
import pandas as pd
(These images are generated by `scripts/generate_sample_charts.py`. If Mermaid does not render in your viewer, copy the diagram block into a Mermaid live editor (https://mermaid.live) to view.)
